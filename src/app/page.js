      ...
      >
        <div
          style={{
            ...
            borderRight: filtersOpen ? "1px solid #e5e7eb" : "none",
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => graphControls?.recenter()}
              style={floatingButtonStyle}
              aria-label="Centra grafo"
              title="Centra grafo"
            >
              ⊕
            </button>
            ...
            <button
              onClick={() => graphControls?.focusSelection()}
              style={floatingButtonStyle}
